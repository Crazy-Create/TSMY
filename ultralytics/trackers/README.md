...
model = YOLO("path/to/visdrone.pt")  # Load a custom trained model
...
yolo track model=path/to/visdrone.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
yolo track model=path/to/visdrone.pt tracker="bytetrack.yaml"
```
